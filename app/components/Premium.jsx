        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-accent/40 bg-bg px-6 py-12 md:px-14 md:py-16">
            ...
            <div className="relative grid items-center gap-12 lg:grid-cols-2">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border-2 border-accent bg-card-cream px-4 py-1.5 text-xs font-extrabold tracking-wide text-ink shadow-md">
                  {emojiSrc('download3') && (
